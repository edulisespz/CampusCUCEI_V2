package cuceimovile.campuscucei_v2.AndroidAR.activity;
...
import cuceimovile.campuscucei_v2.AndroidAR.data.ARData;
import cuceimovile.campuscucei_v2.AndroidAR.data.GooglePlacesDataSource;
import cuceimovile.campuscucei_v2.AndroidAR.data.LocalDataSource;
import cuceimovile.campuscucei_v2.AndroidAR.data.NetworkDataSource;
import cuceimovile.campuscucei_v2.AndroidAR.data.WikipediaDataSource;
import cuceimovile.campuscucei_v2.AndroidAR.ui.Marker;
import cuceimovile.campuscucei_v2.AndroidAR.widget.VerticalTextView;
...
public class Demo extends AugmentedReality {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_main_activity_principal, menu);
        return true;
    }
